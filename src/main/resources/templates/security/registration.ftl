...
<div id="register" class="popup">
    ...
    <form action="/registration" method="POST">
        ...
        <p id="passwordError" class="error-input" hidden>*Le mot de passe doit contenir au minimum: une majuscule et minuscule, un chiffre et un caract̬re sp̩cial</p>
        <p id="passwordLength" class="error-input" hidden>*Le mot de passe doit contenir au moins 8 caract̬res</p>

        <label>Confirmation mot de passe :</label>
        <input class="form-control" id="passwordConfirm" type="password" name="passwordconfirm" onkeyup="validatePassword()">
        <p id="passwordConfirmError" class="error-input" hidden>*Les saisies sont diff̩rentes</p>
